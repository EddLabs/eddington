# -*- coding: utf-8 -*-
#
# Eddington documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath("../src/eddington/"))
...
# of the sidebar.
html_logo = "images/eddington.png"
...
htmlhelp_basename = "eddingtondoc"
