...
def case_poisson():
    return dict(
        ...
        a_derivatives=[
            [0.0732625555549367, -0.219787666664810, 1],
            [0.146525111109873, -1.17220088887899, 1],
            [0.195366814813165, -3.12586903701063, 1],
            [0.195366814813165, 0, 1],
            [0.156293451850532, 40.0111236737361, 1],
            [0.104195634567021, 213.392659593259, 1],
            [0.0595403626097263, 731.631975748317, 1],
            [0.0297701813048632, 1951.01860199551, 1],
            [0.0132311916910503, 4335.59689332336, 1],
        ],
    )
